...
const newListWithNumbersGreaterThan5 = numeros.filter((number) => number > 5)

console.log(newListWithNumbersGreaterThan5)
...
const newListWithEvenNumbers = numeros2.filter((number) => number % 2 === 0 )

console.log(newListWithEvenNumbers)
...
const newListWithPeopleWhoCanWatchMatrix = pessoas.filter((people) => people.idade >= 18 )

console.log(newListWithPeopleWhoCanWatchMatrix)